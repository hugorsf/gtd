<%@ Page Title="Home Page" Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="GeracaoResumo.aspx.cs" Inherits="_GeracaoResumo"  EnableSessionState="True"%>

<asp:Content runat="server" ID="FeaturedContent" ContentPlaceHolderID="FeaturedContent">
    <section class="featured">
        <div class="content-wrapper">
            <hgroup class="title">
                <h1>GERAÇÃO <span class="auto-style1">Visão Resumida </span> </h1> </hgroup>
            
            <nav>
                <ul id="menu0">
                    <li>Trocar para <a href="GeracaoCompleto">Visão Completa</a> </li>
                </ul>
            </nav>
        </div>
    </section>
